...
public class PersonalController {
    ...
    @PostMapping("/personal/checkPwd")
    @ResponseBody
    public Result checkPwd(String pwd, HttpSession httpSession) {
        NewBeeMallUserVO newBeeMallUserVO = (NewBeeMallUserVO)httpSession.getAttribute(Constants.MALL_USER_SESSION_KEY);
        if(pwd.equals(newBeeMallUserVO.getPasswordMd5())){
            return ResultGenerator.genSuccessResult();
        }
        return ResultGenerator.genFailResult("请输入正确的密码");
    }
}
